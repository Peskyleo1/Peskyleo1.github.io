...
function setLanguage(language){
    ...
    $.getJSON("../assets/data/languages.json", function(languagePack) {
        ...
        $("#PageTitle").text(languagePack[lang].NotFound);
        //MENU
        ...
        $("#Title1").text(languagePack[lang].Whoops);
        $("#infoText").text(languagePack[lang].SWR);
        //Buttons
        $("#SaveText").text(languagePack[lang].BackToApp);
